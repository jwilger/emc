    ...
    fn mcp_stdio_verifies_modeled_workflow_artifacts() -> Result<(), Box<dyn Error>> {
        ...
        assert_eq!(
            ...
            "typecheck model/quint/RepairDesk.qnt\n\
             verify --invariant modelIdentityStable,modelVersionStable,modelDigestStable,modelWorkflowsAreDeclared,modelSlicesAreDeclared,modelSliceModulesAreDeclared,modelScenariosAreDeclared,modelDataFlowsAreDeclared,modelOutcomesAreDeclared,modelCommandErrorsAreDeclared,modelCommandsAreDeclared,modelCommandInputsAreDeclared,modelReadModelsAreDeclared,modelViewsAreDeclared,modelAutomationsAreDeclared,modelTranslationsAreDeclared,modelExternalPayloadsAreDeclared,modelStreamsAreDeclared,modelEventsAreDeclared --server-endpoint <endpoint> model/quint/RepairDesk.qnt\n\
