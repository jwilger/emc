...
mod tests {
    ...
    fn lean_slice_module_represents_business_slice_fields() -> Result<(), Box<dyn Error>> {
        ...
        assert!(lean.contains("def sliceReadModels : List SliceReadModelReference := []"));
        assert!(lean.contains(
        ...
        assert!(
            ...
            "Lean slice artifacts must identify controls carrying navigation target data"
        );
        assert!(
            lean.contains(
            ...
            "Lean slice artifacts must require navigation controls to declare a navigation type"
        );
        assert!(
            lean.contains(
        ...
        assert!(
            ...
            "Lean slice artifacts must require external-system navigation to name the external system and handoff contract"
        );
        assert!(
            lean.contains(
        ...
        assert!(
            ...
            "Lean slice artifacts must prove external-system navigation targets name the external system and contract"
        );
        assert!(
            lean.contains(
