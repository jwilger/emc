    ...
    vec![
        ...
        Effect::RunProcess(ProcessInvocation::new(
            ...
            vec![
                ...
                process_argument(
                    "modelIdentityStable,modelVersionStable,modelDigestStable,modelWorkflowsAreDeclared,modelSlicesAreDeclared,modelSliceModulesAreDeclared,modelStreamsAreDeclared",
                ),
                process_argument(format!("model/quint/{module_name}.qnt")),
            ],
            report_line("Quint artifacts verified"),
