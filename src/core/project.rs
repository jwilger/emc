...
fn model_digest(
    ...
    format!(
        "project:name={};version={FORMAL_MODEL_VERSION};workflows={};slices={};scenarios=;data-flows=;outcomes=;command-errors=;commands=;read-models=;views=;automations=;translations=;external-payloads=;streams=;events=",
        project_name.as_ref(),
