...
fn model_digest(
    ...
    format!(
        "project:name={};version={FORMAL_MODEL_VERSION};workflows={};slices={};scenarios=;data-flows=;outcomes=;command-errors=;commands=;command-inputs=;read-models=;read-model-definitions=;read-model-fields=;views=;view-fields=;automations=;translations=;external-payloads=;streams=;events=;event-attributes=",
        project_name.as_ref(),
